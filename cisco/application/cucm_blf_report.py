...
def phone_blf_search():
    SEARCH_BY_DN = "Number"
    SEARCH_BY_USER = "User"
    html_template = "cisco_blfsearch.html"

    html_page_title = 'CUCM BLF report'
    ...
    if form_search.validate_on_submit():
        ...
        if form_search.select_field.data == SEARCH_BY_DN:
            ...
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns="http://www.cisco.com/AXL/API/11.5">
                ...
                <soapenv:Body>
                    <ns:executeSQLQuery>
                        <sql>select name,description from device where pkid in (select fkdevice from blfspeeddial where blfdestination like '"""
            msg_end = """%')
                        </sql>
                    </ns:executeSQLQuery>
                </soapenv:Body>
            ...
            <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns="http://www.cisco.com/AXL/API/11.5">
                ...
                <soapenv:Body>
                    <ns:executeSQLQuery>
                        <sql>select name,description from device where pkid in (select fkdevice from blfspeeddial where label like '"""
            msg_end = """%')
                        </sql>
                    </ns:executeSQLQuery>
                </soapenv:Body>
